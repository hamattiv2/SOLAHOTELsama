...
var room1Trigger = document.querySelectorAll('.room1');
new LuminousGallery(room1Trigger);

var room2Trigger = document.querySelectorAll('.room2');
new LuminousGallery(room2Trigger);

var room3Trigger = document.querySelectorAll('.room3');
new LuminousGallery(room3Trigger);

var room4Trigger = document.querySelectorAll('.room4');
new LuminousGallery(room4Trigger);